    ...
    <div className="group relative mt-6">
      ...
      {error && (
        <div className="relative mt-2">
          ...
          <div className="relative rounded-2xl border border-red-400/20 bg-red-500/5 p-2 backdrop-blur-md">
            <span className="text-xs font-light text-red-300">{error}</span>
          </div>
        </div>
      )}
    </div>
